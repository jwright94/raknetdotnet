...
namespace RakNetDotNetSample
{
    ...
    class Server
    {
        ...
        public void Start()
        {
            SocketDescriptor[] socketDescriptors = new SocketDescriptor[] { new SocketDescriptor(61160, "") };
            bool b = server.Startup(128, 30, socketDescriptors, (uint)socketDescriptors.Length);
